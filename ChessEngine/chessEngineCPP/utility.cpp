...
bool is_in_check(map<pair<int, int>, char>& current_board, map<char, vector<pair<pair<int, int>, pair<int, int>>>>& moves_list, char player) {
    char opponent = (player == 'b') ? 'w': 'b';
    pair<int, int> king_pos = find_specific_king_pos(current_board, player);
    cout << king_pos.first << king_pos.second << endl;
...
bool is_attacking(map<char, vector<pair<pair<int, int>, pair<int, int>>>>& moves_list, char player, pair<int, int> square) {
